...
public class FakeRestaurantNotificationGateway implements
        RestaurantNotificationGateway {

    public NotificationDetails sendOrder(Order order) {
        return new NotificationDetails("X", new Date());
    }
