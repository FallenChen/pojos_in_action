...
/**
 *  AcknowledgeOrderService that uses detached objects and pessimistic locking
 */
public interface DetachingAcknowledgeOrderServiceWithLock {
    public AcknowledgeOrderResult getOrderToAcknowledge(
            String orderId);

    public AcknowledgeOrderResult verifyOrderUnchanged(Order order);

    public AcknowledgeOrderResult acknowledgeOrder(String caller, Order order);
