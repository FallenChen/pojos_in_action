...
public class ModifyOrderServiceObjectLockImplTests extends MockObjectTestCase {
	...
	protected void setUp() throws Exception {
		...
		service = new ModifyOrderServiceObjectLockImpl(orderRepository,
				pendingOrderRepository, restaurantRepository);
	...
	public void testGetOrderToMotify() {
		...
		mockOrderFromRepository.expects(once()).method("acquireLock").with(
				eq(caller)).will(returnValue(true));
