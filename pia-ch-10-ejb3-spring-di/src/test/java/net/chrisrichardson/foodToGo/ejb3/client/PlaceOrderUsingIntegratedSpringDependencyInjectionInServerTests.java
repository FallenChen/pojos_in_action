...
import net.chrisrichardson.foodToGo.ejb3.facadeWithSpringDI.*;

public class PlaceOrderUsingIntegratedSpringDependencyInjectionInServerTests
		extends EJB3TestCase {

	public void testPlaceOrderFacadeWithIntegratingDIInServer()
			throws Exception {
		PlaceOrderFacade facade = (PlaceOrderFacade) ctx
				.lookup(PlaceOrderFacadeUsingIntegratedDependencyInject.class
						.getName());

		// FIXME - This code mostly duplicates other client test code
