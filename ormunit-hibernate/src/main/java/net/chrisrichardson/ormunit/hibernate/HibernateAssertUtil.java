...
public class HibernateAssertUtil {
    ...
    public static void assertColumn(String idColumn,
            Value identifier) {
    ...
    public static void assertPropertyColumn(String idColumn,
            Property idProperty) {
        Value identifier = idProperty.getValue();
        assertColumn(idColumn, identifier);
    }

    public static Set getPersistableFields(Class type) {
        Set persistableFields = new HashSet();
    ...
    public static void assertFieldAccess(Property property) {
        Assert.assertEquals("field", property
